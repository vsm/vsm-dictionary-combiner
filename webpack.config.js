/*
This Webpack-config builds a version of VsmDictionaryCombiner that can be
...
module.exports = () => ({
  ...
  entry: src + '/DictionaryCombiner.js',
  ...
  output: {
    path: dist,
    filename: 'vsm-dictionary-combiner.min.js',
    library: 'VsmDictionaryCombiner',
    libraryTarget: 'var'
  }
});
